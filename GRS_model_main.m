...
switch if_fault
    case 0
        load_system('GRS_model.slx')
        set_param('GRS_model','SimulationCommand','start')
        while(string(get_param('GRS_model','SimulationStatus'))== "running")  
              pause(0.5);
        end
    case 1
        load_system('GRS_model_fault.slx')
        set_param('GRS_model_fault','SimulationCommand','start')
        while(string(get_param('GRS_model_fault','SimulationStatus'))== "running")  
              pause(0.5);
        end
    case 2
        load_system('GRS_model_fault.slx')
